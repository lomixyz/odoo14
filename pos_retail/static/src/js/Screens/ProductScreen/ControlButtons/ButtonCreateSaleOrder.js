    ...
    class ButtonCreateSaleOrder extends PosComponent {
        ...
        async onClick() {
            ...
            if (confirmed) {
                ...
                let value = {
                    // create_date:order.creation_date,
                    name: order.name,
                ...
                order.delivery_address = popupValue.delivery_address;
                order.delivery_phone = popupValue.delivery_phone;
                order.delivery_date = popupValue.delivery_date;
                order.payment_partial_amount = popupValue.payment_partial_amount;
                order.create_date=moment(order.creation_date).format('YYYY-MM-DD hh:mm'),
                order.note = popupValue.note;
