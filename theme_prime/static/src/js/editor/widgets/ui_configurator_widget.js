...
let UIConfiguratorWidget = AbstractWidget.extend({
    ...
    */
    ...
    _getDefaultOptions: function () {
        return {quick_view: true, add_to_cart: true, wishlist: true, comparison: true, description_sale: false, rating: true, label: true, ppr: 4, col_size: 12 / 4, images: false, layoutType: 'slider', category_info: false};
    },
    /**
