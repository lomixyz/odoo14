...
cardRegistry
    ...
    .add('s_card_style_3', {previewTemplate: 's_card_style_3', parentClass: 's_card_style_3', options: {category_info: true}})
    ...
    .add('s_card_style_6', {previewTemplate: 's_card_style_6', parentClass: 's_card_style_6'})
