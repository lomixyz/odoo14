...
publicWidget.registry.productsRecentlyViewedSnippet.include({
    ...
    _render: function (res) {
        ...
        _.each(products, function (product, index) {
            if (productsTemp.length === config.device.size_class) {
        ...
        this.webCarousel = $(qweb.render('website_sale.productsRecentlyViewed', {uniqueId: this.uniqueId, productFrame: config.device.size_class, productsGroups: webProducts}));
        this._addCarousel();
