...
let HotspotMixns = {
    ...
    _cleanNodeAttr: function () {
        if (_.has(odoo.dr_theme_config, "is_public_user") && odoo.dr_theme_config.is_public_user) {
            let attrs = ['data-image-src', 'data-hotspot-type', 'data-title-text', 'data-subtitle-text', 'data-button-link', 'data-button-text', 'data-top', 'data-on-hotspot-click', 'data-product-id'];
            attrs.forEach(attr => {
