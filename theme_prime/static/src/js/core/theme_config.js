...
'use strict';
    ...
    var ThemeOptionCategoryPills = AbstractThemeOption.extend({
        ...
        events: {change: '_onChange'},
        _onChange: function (ev) {
            var vals = { enable: this.$('#category_pills_enabled').prop('checked'), enable_child: this.$('#category_pills_enabled_child').prop('checked'), hide_desktop: this.$('#category_pills_hide_desktop').prop('checked')};
            this.setValue(vals);
        }
    });
    ...
    var ThemeConfigDialog = Dialog.extend({
        ...
        _tabInfo: function () {
            return [{
                ...
                icon: 'fa fa-sliders',
                label: _t('General'),
                widgets: [ThemeOptionCartFlow, ThemeOptionGeneralCategorySearch, ThemeOptionGeneralBrandsPage]
            }, {
                name: 'ShopConfig',
                ...
                widgets: [ThemeOptionZoom, ThemeOptionStickyAddtoCart]
            }, {
                name: 'MobileConfig',
                icon: 'fa fa-mobile',
                label: _t('Mobile'),
