...
class ThemePrimePWA(http.Controller):
    ...
    @http.route('/service_worker.js', type='http', auth='public', website=True)
    ...
    @http.route('/pwa/offline_page', type='http', auth='public', website=True, cors='*')
    def get_pwa_offline_page(self, **kargs):
        return request.render('theme_prime.pwa_offline_page', {})

    @http.route('/pwa/logo.png', type='http', auth='public', website=True, cors='*')
    ...
    @http.route('/pwa/is_pwa_actived', type='http', auth='public', website=True)
