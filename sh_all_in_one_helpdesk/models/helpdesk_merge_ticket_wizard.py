...
class MergeTicketWizard(models.TransientModel):
    ...
    def _onchange_team_id(self):
            self.sh_team_head_id=self.team_id.team_head.id if self.team_id else False
    ...
    def action_merge_tickets(self):
        ...
        if self.sh_select_type=='new':
            ...
            merged_ticket = self.env['helpdesk.ticket'].create({
                ...
                'domain_user_ids': [(6,0,self.domain_user_ids.ids)] if self.domain_user_ids.ids else [],
