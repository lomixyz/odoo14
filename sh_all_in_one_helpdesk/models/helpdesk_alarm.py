                                ...
                                if alarm.type == 'popup':
                                    ...
                                    if fields.Date.today() == deadline_date.date() and deadline_date.hour == now.hour and deadline_date.minute == now.minute:
                                        ...
                                        if ticket.ticket_type_id:
                                            message+="<strong>Type :</strong>"+str(ticket.ticket_type_id.name) + "</br>"
                                        ...
                                        multi_users = []
                                        if ticket.domain_user_ids:
                                            for user in ticket.domain_user_ids: 
                                        ...
                                        if ticket.domain_user_ids:
                                            for user_id in ticket.domain_user_ids: 
