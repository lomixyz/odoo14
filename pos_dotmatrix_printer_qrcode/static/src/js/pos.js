odoo.define('pos_dotmatrix_printer_qrcode', function (require) {
"use strict";

    const PosTicketFormat = require('pos_dotmatrix_printer')
    const Registries = require('point_of_sale.Registries');

    const PosTicketFormatQRCodeSA = PosTicketFormat =>
        class extends PosTicketFormat {
            mounted() {
                super.mounted(...arguments);
                if (this._receiptEnv.order.pos.company.country.code ) {
    ...
    Registries.Component.extend(PosTicketFormat, PosTicketFormatQRCodeSA)
    return PosTicketFormatQRCodeSA
