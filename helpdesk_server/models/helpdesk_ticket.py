...
class HelpdeskTicket(models.Model):
    ...
    external_mail_server = fields.Char('external_mail_server', compute='_compute_external_mail_server')

    def _compute_external_mail_server(self):
        self.external_mail_server = self.env['ir.mail_server'].sudo().search([('sequence', '=', 1)]).smtp_user
            ...
            try:
                ...
                for email in email_list:
                    msg = IrMailServer.build_email(
                        email_from=self.external_mail_server,
