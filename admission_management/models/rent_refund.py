...
class rent_refund_inherit(models.TransientModel):
    _inherit = "account.move.reversal"


    def reverse_moves(self):
        if self.env.context.get('active_model') == 'rent.cancel':
            rent_cancel_obj = self.env['rent.cancel'].search([('id','=',self.env.context['active_id'])])
            moves = self.env['account.move'].browse(rent_cancel_obj.invoice_id.id) 
        else:
